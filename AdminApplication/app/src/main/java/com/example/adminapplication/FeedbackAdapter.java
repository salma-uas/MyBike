...
public class FeedbackAdapter extends RecyclerView.Adapter<FeedbackAdapter.BookingViewHolder> {
...
//    String ip = sharedPrefManager.getIP();
    ...
    private List<Feedback> bookingList; // list of staff
    //private String imgUrl = IPAddress.ROOT_HTTP + ip +IPAddress.ROOT_URL_IMAGE;


    public FeedbackAdapter(Context mCtx, List<Feedback> bookingList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(BookingViewHolder holder, int position) {
        final Feedback booking = bookingList.get(position);
     //   final int id = staff.getId();
        ...
        holder.txtRiderName.setText("Driver: " + booking.getRider_name());
        holder.txtPassengerName.setText("Passenger: " +booking.getPassenger_name());
    ...
    class BookingViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView imageView;
        TextView txtDateTime, txtPrice, txtStatus, txtPickupPoint, txtDestination, txtRiderName, txtPassengerName;
        CardView cardView;
        RatingBar  txtRating;
      //  Button share;
        ...
        public BookingViewHolder(final View itemView) {
            ...
            txtRiderName = itemView.findViewById(R.id.txtRiderName);
            txtPassengerName = itemView.findViewById(R.id.txtPassengerName);
